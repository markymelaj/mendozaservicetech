      ...
      <section className="mobile-section">
        <div className="section-wrap mobile-layout">
          ...
          <div className="mobile-copy">
            ...
            <p>Activá la vista móvil, escaneá el QR y consultá las órdenes activas desde un teléfono conectado al mismo Wi-Fi del taller. Sin depender de una nube externa.</p>
